...
- **Generated app delivery rail**: the `app` template reads optional `delivery-summary.json` evidence at runtime and shows delivery acceptance, source-readiness, spatial-query, and follow-up signals in the map status banner.
