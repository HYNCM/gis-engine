  ...
  groups: [
    ...
    },
    {
      ...
      naturalLanguage: [
        ...
        "show raster tiles",
        "use DEM terrain",
        "add image/video/canvas overlay",
      ],
    ...
    },
    {
      ...
      aiInvocation: {
        ...
        requiresContractFor: [
          "all 87 expression operators",
          "type-directed expression synthesis",
          "feature-state/global-state write paths",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      aiInvocation: {
        status: "not-yet-commanded",
        requiresContractFor: [
          "terrain source schema",
          "projection command",
          "sky/light command",
          "2.5D promotion gates",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      naturalLanguage: [
        "run this when the map loads",
        "listen for clicks on a layer",
        "wait until idle",
        "redraw",
        "resize",
      ],
