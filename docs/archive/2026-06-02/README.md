...
This archive contains documents that were superseded or have aged past their
active reference window during the 2026-06-02 documentation cleanup.
...
The following categories were deleted (not archived) as they have no lasting reference value:

- **Old daily audits** (May 25–27, 2026): daily snapshots superseded by later audits.
- **Old documentation audits** (May 25–28, 2026): formatting/link checks whose issues have been resolved.
- **Old quality gates** (May 25–27, 2026): pass/fail snapshots with no ongoing decisions.
- **Archive/2026-05-30 stale files**: older audits and intermediate diagnostics already superseded.

See the [2026-06-02 cleanup report](../../reviews/documentation-audit-2026-06-02.md) if available, or the commit message for details.
