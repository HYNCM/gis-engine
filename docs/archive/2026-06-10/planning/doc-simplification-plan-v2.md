...
| 文档 | 当前引用证据 | 处置 |
| --- | --- | --- |
| `docs/archive/2026-06-10/reviews/productization-review-2026-06-07.md` | `docs/archive/2026-06-10/planning/next-stage-tasks-2026-06-07.md:7`；未跟踪 merged 草稿也引用它 | 保留 canonical；不得用未跟踪草稿覆盖 |
...
| 旧建议 | 当前判断 | 替代动作 |
| --- | --- | --- |
| 删除 `docs/archive/2026-06-10/reviews/productization-review-2026-06-07.md` | 阻断。该文件是 tracked canonical，并包含 `d57e62a` 的执行 addendum、CLI install smoke、release preflight、Workbench checklist、外部信号刷新。 | 保留。若要做综合版，必须基于当前 canonical 重新生成，并作为新增评审而非替代删除。 |
...
| 保留 `docs/archive/2026-06-10/reviews/productization-review-2026-06-07.md` | 当前产品化执行证据 | `rg -n "productization-review-2026-06-07" docs/planning docs/reviews docs/research` |
