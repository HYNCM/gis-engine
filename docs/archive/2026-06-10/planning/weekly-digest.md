...
| TASK-2026W23-AMW-006 | done | `docs/research/competitor-updates-2026-W23.md`; `docs/archive/2026-06-10/feature-specs/ai-map-workbench-product-boundary.md`; `docs/planning/sprint-2026-W23-ai-map-workbench-product-boundary.md`; `docs/archive/2026-06-10/reviews/amw-006-product-boundary-planning-2026-06-01.md` |
| TASK-2026W23-AMW-007 | done | `docs/archive/2026-06-10/feature-specs/ai-map-workbench-provider-administration.md`; `docs/archive/2026-06-10/reviews/amw-007-provider-resource-admin-2026-06-01.md`; provider credential/resource administration design before hosted/product use |
| TASK-2026W23-AMW-008 | done | `docs/archive/2026-06-10/feature-specs/ai-map-workbench-durable-audit.md`; `docs/archive/2026-06-10/reviews/amw-008-durable-audit-retention-export-2026-06-01.md`; durable audit retention/export design before persistent storage or product promotion |
| TASK-2026W23-AMW-009 | done | `docs/archive/2026-06-10/feature-specs/ai-map-workbench-review-actions.md`; command-safe accept/block/follow-up review action design |
| TASK-2026W23-AMW-010 | done / no-go | `docs/archive/2026-06-10/reviews/amw-010-product-promotion-go-no-go-2026-06-02.md`; local example Go, product app and hosted promotion No-go |
| TASK-2026W23-AWP-001 | done | `docs/archive/2026-06-10/feature-specs/ai-map-workbench-product-implementation.md`; `docs/planning/sprint-2026-W23-ai-map-workbench-product-implementation.md`; implementation loop opened without product promotion |
| TASK-2026W23-AWP-002 | done | `docs/archive/2026-06-10/reviews/awp-002-provider-resource-enforcement-2026-06-02.md`; provider base URL policy, timeout/abort, response byte cap, and leak regressions |
| TASK-2026W23-AWP-003 | done | `docs/archive/2026-06-10/reviews/awp-003-product-ownership-project-model-2026-06-02.md`; product ownership, route/module boundary, project identity model, and non-go language |
| TASK-2026W23-AWP-004 | done | `docs/archive/2026-06-10/reviews/awp-004-authorized-durable-audit-contract-2026-06-02.md`; durable audit contract helpers for project-scoped access, export caps, deletion receipts, and raw-payload rejection |
| TASK-2026W23-AWP-005 | done | `docs/archive/2026-06-10/reviews/awp-005-command-safe-review-decisions-2026-06-02.md`; command-safe review decisions as append-only evidence, not direct `MapSpec` mutation |
| TASK-2026W23-AWP-006 | done | `docs/archive/2026-06-10/reviews/awp-006-repeatable-workbench-ui-evidence-2026-06-02.md`; repeatable workbench UI evidence for provider, evidence, diagnostics, audit, and review-decision states |
| TASK-2026W23-AWP-007 | done / no-go | `docs/archive/2026-06-10/reviews/awp-007-product-implementation-go-no-go-2026-06-02.md`; local example hardening Go, product/hosted promotion No-go |
