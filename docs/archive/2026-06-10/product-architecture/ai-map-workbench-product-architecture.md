...
inputs:
  ...
  - docs/archive/2026-06-10/reviews/amw-001-product-evolution-2026-05-31.md
...
`docs/archive/2026-06-10/feature-specs/ai-map-workbench-product-implementation.md` and
...
`docs/archive/2026-06-10/reviews/awp-003-product-ownership-project-model-2026-06-02.md`. The
...
`docs/archive/2026-06-10/feature-specs/ai-map-workbench-provider-administration.md`. The
...
`docs/archive/2026-06-10/feature-specs/ai-map-workbench-durable-audit.md`. The design
...
`docs/archive/2026-06-10/feature-specs/ai-map-workbench-review-actions.md`. Accept, block,
