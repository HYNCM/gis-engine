...
`docs/archive/2026-06-10/reviews/amw-007-provider-resource-admin-2026-06-01.md` and
`docs/archive/2026-06-10/reviews/amw-008-durable-audit-retention-export-2026-06-01.md`, AMW-007
and AMW-008 are closed. After
`docs/archive/2026-06-10/reviews/amw-009-command-safe-review-actions-2026-06-02.md`, AMW-009 is
...
| AMW product hold | accepted | `docs/archive/2026-06-10/reviews/amw-004-promotion-gate-2026-05-31.md` holds product promotion pending app boundary, credential/resource review, durable audit, visual evidence, and review actions. | The next task must design the missing product boundary before moving files or hosting. | Start with provider credential/resource administration. | high |
| Provider profile safety | accepted | `docs/archive/2026-06-10/reviews/amw-005-provider-profiles-2026-05-31.md` accepts server-side provider profiles but keeps product promotion on hold. | Existing code can stay local/example-scoped while product requirements are planned. | Preserve server-only credential lookup and browser-safe metadata. | high |
