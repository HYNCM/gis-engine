...
`docs/archive/2026-06-10/reviews/amw-008-durable-audit-retention-export-2026-06-01.md`, AMW-008 is
closed. After `docs/archive/2026-06-10/reviews/amw-009-command-safe-review-actions-2026-06-02.md`,
...
| Resource policy alignment | accepted | `docs/archive/2026-06-10/feature-specs/ai-map-workbench-provider-administration.md` records provider resource rules without changing runtime policy code. | Product planning gets explicit external-call boundaries while implementation remains unchanged. | Map any future URL/resource policy change to engine policy docs and tests. | high |
