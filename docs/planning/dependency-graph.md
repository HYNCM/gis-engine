...
| AI-native next loop | in progress | `TASK-2026W22-AIN-001` and `TASK-2026W22-AIN-002` are done via `docs/reviews/ain-001-002-generated-app-delivery-acceptance-2026-05-30.md`; remaining tasks cover source promotion candidates, spatial-analysis promotion criteria, and scene browsing copy |
