...
| Data and sources | source readiness summary, resource-policy result, source diagnostics | GeoJSON/raster/vector/PMTiles states match existing policy and examples | GeoParquet/FlatGeobuf public schema-policy contracts, GeoTIFF, GeoZarr, and new PMTiles archive behavior remain readiness-only or blocked until promotion gates land |
