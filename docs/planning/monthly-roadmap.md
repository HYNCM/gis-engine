...
| --- | --- | --- |
| Open queue | #25 is the active P0 productization gate for Review-console Workbench route evidence | [issues snapshot](./issues-snapshot.md) |
...
| AI Map Workbench | #25 may advance a feature-flagged product-route candidate; hosted GA remains blocked | [Workbench Go gate](./feature-specs/review-console-workbench-go-gate.md) |
...
| Item | Scope | Owner |
| --- | --- | --- |
| Review-console Workbench | Complete #25 route candidate evidence and @quality Go/No-go before hosted launch planning | @builder |
...
| Studio/Workbench productization | **Candidate gate active** — #25 can move feature-flagged route evidence only | Hosted GA remains No-go until a separate launch issue approves auth, deployment, monitoring, and support |
