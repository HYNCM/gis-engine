...
`TASK-2026W23-AWP-005` is complete as command-safe review decision runtime
evidence. The next queued task is `TASK-2026W23-AWP-006`, and it must produce
repeatable UI smoke or visual evidence for provider selector, evidence rails,
diagnostics, audit, and review-decision states.
