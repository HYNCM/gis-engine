...
`TASK-2026W23-SQH-005` should enter execution state next. It must keep the
hardening slice to generated-app delivery mapping and avoid widening into
PMTiles/vector parsing, new MCP tools, or advanced geoprocessing.
