...
| --- | ---: | ---: | --- | --- | --- |
| 1 | SceneView3D stable runtime promotion remains blocked after no-go verdict | 0.42 | W23 gate accepted the promotion-readiness package, but the promotion verdict keeps stable runtime blocked and the browser matrix / adapter summary / docs alignment are now in place | keep the blocker codes and wait for a future explicit stable-runtime approval | medium |
