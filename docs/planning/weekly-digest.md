...
4. 下一轮 sprint 不再从零拆分 SceneView3D；W25 已完成 schema、fixtures、loader resource gate、scene commands 和 package boundary，W27-001/002/003/004/005 与 W28-001 已完成，后续应沿既有 DAG 在 adapter package 内补真实 renderer evidence。
...
- `product-strategist -> task-distributor`: W21/W23 当前规划项完成；3D 工作已进入 W25/W28 SceneView3D DAG，下一批应聚焦真实 renderer evidence，不直接接入 core runtime。
