...
#### properties.sourceReadiness.items.properties.fixtureEvidenceReady

> `readonly` **fixtureEvidenceReady**: `object`

#### properties.sourceReadiness.items.properties.fixtureEvidenceReady.type

> `readonly` **type**: `"boolean"` = `"boolean"`

#### properties.sourceReadiness.items.properties.fixtureEvidenceStatus

> `readonly` **fixtureEvidenceStatus**: `object`

#### properties.sourceReadiness.items.properties.fixtureEvidenceStatus.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.fixtureEvidenceStatus.enum
...
#### properties.sourceReadiness.items.properties.capabilityDecision

> `readonly` **capabilityDecision**: `object` = `PMTilesCapabilityDecisionSchema`

#### properties.sourceReadiness.items.properties.capabilityDecision.type

> `readonly` **type**: `"object"` = `"object"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties

> `readonly` **properties**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display

> `readonly` **display**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.type

> `readonly` **type**: `"object"` = `"object"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.properties

> `readonly` **properties**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.properties.status

> `readonly` **status**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.properties.status.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.properties.status.const

> `readonly` **const**: `"go"` = `"go"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.properties.scope

> `readonly` **scope**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.properties.scope.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.properties.scope.const

> `readonly` **const**: `"url-compatible-maplibre-vector-display"` = `"url-compatible-maplibre-vector-display"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.required

> `readonly` **required**: readonly \[`"status"`, `"scope"`\]

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.display.additionalProperties

> `readonly` **additionalProperties**: `false` = `false`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load

> `readonly` **load**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.type

> `readonly` **type**: `"object"` = `"object"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties

> `readonly` **properties**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.status

> `readonly` **status**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.status.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.status.const

> `readonly` **const**: `"no-go"` = `"no-go"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.scope

> `readonly` **scope**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.scope.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.scope.const

> `readonly` **const**: `"runtime-archive-load"` = `"runtime-archive-load"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.blockerCode

> `readonly` **blockerCode**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.blockerCode.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.properties.blockerCode.const

> `readonly` **const**: `"PMTILES.RUNTIME_ARCHIVE_LOAD_BLOCKED"` = `"PMTILES.RUNTIME_ARCHIVE_LOAD_BLOCKED"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.required

> `readonly` **required**: readonly \[`"status"`, `"scope"`, `"blockerCode"`\]

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.load.additionalProperties

> `readonly` **additionalProperties**: `false` = `false`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery

> `readonly` **featureQuery**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.type

> `readonly` **type**: `"object"` = `"object"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties

> `readonly` **properties**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.status

> `readonly` **status**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.status.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.status.const

> `readonly` **const**: `"no-go"` = `"no-go"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.scope

> `readonly` **scope**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.scope.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.scope.const

> `readonly` **const**: `"runtime-archive-feature-query"` = `"runtime-archive-feature-query"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.blockerCode

> `readonly` **blockerCode**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.blockerCode.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.properties.blockerCode.const

> `readonly` **const**: `"PMTILES.RUNTIME_FEATURE_QUERY_BLOCKED"` = `"PMTILES.RUNTIME_FEATURE_QUERY_BLOCKED"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.required

> `readonly` **required**: readonly \[`"status"`, `"scope"`, `"blockerCode"`\]

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQuery.additionalProperties

> `readonly` **additionalProperties**: `false` = `false`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan

> `readonly` **loadPlan**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.type

> `readonly` **type**: `"object"` = `"object"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.properties

> `readonly` **properties**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.properties.status

> `readonly` **status**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.properties.status.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.properties.status.const

> `readonly` **const**: `"go"` = `"go"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.properties.scope

> `readonly` **scope**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.properties.scope.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.properties.scope.const

> `readonly` **const**: `"io-free-caller-metadata-preflight"` = `"io-free-caller-metadata-preflight"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.required

> `readonly` **required**: readonly \[`"status"`, `"scope"`\]

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadPlan.additionalProperties

> `readonly` **additionalProperties**: `false` = `false`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadGates

> `readonly` **loadGates**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadGates.type

> `readonly` **type**: `"array"` = `"array"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadGates.items

> `readonly` **items**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadGates.items.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.loadGates.items.enum

> `readonly` **enum**: readonly \[`"archive-metadata"`, `"columnar-directory-lookup"`, `"offset-continuation"`, `"internal-compression"`, `"leaf-directory-traversal"`, `"cancellation"`, `"byte-budget"`, `"range-budget"`, `"cache-behavior"`, `"resource-policy-before-io"`\]

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQueryGates

> `readonly` **featureQueryGates**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQueryGates.type

> `readonly` **type**: `"array"` = `"array"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQueryGates.items

> `readonly` **items**: `object`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQueryGates.items.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.sourceReadiness.items.properties.capabilityDecision.properties.featureQueryGates.items.enum

> `readonly` **enum**: readonly \[`"query-semantics"`, `"query-diagnostics"`, `"adapter-boundary"`, `"payload-free-evidence"`, `"query-tests"`, `"docs"`\]

#### properties.sourceReadiness.items.properties.capabilityDecision.required

> `readonly` **required**: readonly \[`"display"`, `"load"`, `"featureQuery"`, `"loadPlan"`, `"loadGates"`, `"featureQueryGates"`\]

#### properties.sourceReadiness.items.properties.capabilityDecision.additionalProperties
