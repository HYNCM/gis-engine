...
# Variable: SnapshotSpecToolInputSchema

> `const` **SnapshotSpecToolInputSchema**: `object`
...
#### properties.snapshot.properties.width

> `readonly` **width**: `object`

#### properties.snapshot.properties.width.type

> `readonly` **type**: `"number"` = `"number"`

#### properties.snapshot.properties.height

> `readonly` **height**: `object`

#### properties.snapshot.properties.height.type

> `readonly` **type**: `"number"` = `"number"`

#### properties.snapshot.properties.pixelRatio

> `readonly` **pixelRatio**: `object`

#### properties.snapshot.properties.pixelRatio.type

> `readonly` **type**: `"number"` = `"number"`

#### properties.snapshot.properties.format

> `readonly` **format**: `object`

#### properties.snapshot.properties.format.type

> `readonly` **type**: `"string"` = `"string"`

#### properties.snapshot.properties.format.enum

> `readonly` **enum**: readonly \[`"png"`, `"jpeg"`, `"data-url"`\]

#### properties.snapshot.properties.targetLayers

> `readonly` **targetLayers**: `object`

#### properties.snapshot.properties.targetLayers.type

> `readonly` **type**: `"array"` = `"array"`

#### properties.snapshot.properties.targetLayers.items

> `readonly` **items**: `object`

#### properties.snapshot.properties.targetLayers.items.type
