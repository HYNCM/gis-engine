...
# Interface: GeoParquetWasmReadinessReport

## Properties

### status

> **status**: [`GeoParquetWasmStatus`](../type-aliases/GeoParquetWasmStatus.md)
...
> **metadata**: [`GeoParquetMetadata`](GeoParquetMetadata.md) \| `null`
