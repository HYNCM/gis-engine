...
const showcaseFeatures: GeoJSON.Feature[] = [
  {
    ...
    properties: { name: "Tokyo", name_en: "Tokyo", code: "JP-TKY", population: 37400068, area: 13572, magnitude: 7.2 },
  },
  {
    type: "Feature",
  ...
  },
  {
    ...
    properties: { name: "London", code: "GB-LON", population: 9540000, area: 8382, magnitude: 2.8 },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [2.35, 48.86] },
    properties: { name: "Paris", name_en: "Paris", code: "FR-PAR", population: 11020000, area: 10534, magnitude: 2.5 },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [116.4, 39.9] },
    properties: { name: "北京", name_en: "Beijing", code: "CN-BJS", population: 21540000, area: 16410, magnitude: 5.4 },
  },
  {
    type: "Feature",
  ...
  },
  {
    ...
    properties: { name: "मुंबई", name_en: "Mumbai", population: 20667656, area: 4355, magnitude: 5.1 },
  },
  {
    type: "Feature",
  ...
  layers: [
    ...
    // -------------------------------------------------------------------------
    {
      ...
      paint: {
        ...
        "circle-radius": ["interpolate", ["exponential", 1.5], ["get", "magnitude"], 0, 2, 9, 50],
        "circle-color": [
          "interpolate",
          ["linear"],
          ["get", "magnitude"],
