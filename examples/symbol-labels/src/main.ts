...
const cityFeatures: GeoJSON.Feature[] = [
  {
    ...
    properties: { name: "Tokyo", population: 37400068, country: "Japan", type: "megacity" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [-74.0, 40.71] },
    properties: { name: "New York", population: 18819000, country: "USA", type: "megacity" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [-0.12, 51.51] },
    properties: { name: "London", population: 9540000, country: "UK", type: "capital" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [2.35, 48.86] },
    properties: { name: "Paris", population: 11020000, country: "France", type: "capital" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [37.62, 55.76] },
    properties: { name: "Moscow", population: 12506468, country: "Russia", type: "capital" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [116.4, 39.9] },
    properties: { name: "Beijing", population: 21540000, country: "China", type: "megacity" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [28.98, 41.01] },
    properties: { name: "Istanbul", population: 15620000, country: "Turkey", type: "megacity" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [72.88, 19.08] },
    properties: { name: "Mumbai", population: 20667656, country: "India", type: "megacity" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [31.24, 30.04] },
    properties: { name: "Cairo", population: 21750020, country: "Egypt", type: "capital" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [-43.17, -22.91] },
    properties: { name: "Rio de Janeiro", population: 6748000, country: "Brazil", type: "major" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [151.21, -33.87] },
    properties: { name: "Sydney", population: 5312000, country: "Australia", type: "major" },
  },
  {
    type: "Feature",
    geometry: { type: "Point", coordinates: [36.82, -1.29] },
    properties: { name: "Nairobi", population: 4397073, country: "Kenya", type: "capital" },
  },
];
  ...
  layers: [
    {
      ...
      layout: {
        ...
        "icon-size": ["interpolate", ["linear"], ["zoom"], 2, 0.8, 10, 1.5],
        // Prevent label and icon overlap
        "text-allow-overlap": false,
        "icon-allow-overlap": false,
      },
      paint: {
        "text-color": ["match", ["get", "type"], "megacity", "#c62828", "capital", "#1565c0", "#333333"],
