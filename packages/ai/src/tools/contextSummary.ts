...
type SourceRuntimeLoadPlanSummary = {
  ...
  requirements: SourceRuntimeReadinessSummary["requirements"];
};
...
function summarizeRuntimeLoadPlan(plan: SourceRuntimeReadinessSummary): SourceRuntimeLoadPlanSummary {
  return {
    status: plan.status,
