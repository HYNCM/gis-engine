export const DiagnosticCodes = {
  ...
  GeoParquetVersionRequired: "GEOPARQUET.VERSION_REQUIRED",
  GeoParquetVersionUnsupported: "GEOPARQUET.VERSION_UNSUPPORTED",
  GeoParquetMetadataAmbiguous: "GEOPARQUET.METADATA_AMBIGUOUS",
  GeoParquetMetadataIncompatible: "GEOPARQUET.METADATA_INCOMPATIBLE",
